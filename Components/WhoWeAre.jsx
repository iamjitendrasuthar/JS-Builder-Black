      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center relative max-w-4xl mx-auto mb-24">
          <FadeIn>
            ...
            <span className="inline-block bg-white/5 rounded-full px-5 py-1.5 text-neutral-400 font-medium text-sm mb-8">
              Who we are
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Left Dark Card */}
          <FadeIn delay={0.3} className="bg-[#1C1C1C] rounded-[32px] p-8 md:p-12 relative overflow-hidden flex flex-col justify-between min-h-[420px]">
            ...
            <div className="mt-16 relative flex items-end">
              ...
              <div className="flex items-end -space-x-4 relative z-10 ml-4 pb-4">
                <div className="w-[60px] h-[70px] rounded-t-full border-[4px] border-[#1C1C1C] overflow-hidden relative z-0">
                  <img src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&q=80&w=150" alt="Interior detail" className="w-full h-full object-cover" />
                </div>
                <div className="w-[70px] h-[85px] rounded-t-full border-[4px] border-[#1C1C1C] overflow-hidden relative z-10 mb-3 shadow-xl">
                  <img src="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&q=80&w=150" alt="Exterior building" className="w-full h-full object-cover" />
                </div>
                <div className="w-[60px] h-[70px] rounded-t-full border-[4px] border-[#1C1C1C] overflow-hidden relative z-0">
                  <img src="https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=150" alt="Living room" className="w-full h-full object-cover" />
                </div>
              </div>
          ...
          {/* Right Image Card */}
          <FadeIn delay={0.4} className="rounded-[32px] overflow-hidden min-h-[420px] h-full">
            <img
